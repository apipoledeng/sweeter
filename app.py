...
SECRET_KEY = 'Kentang'
# MONGODB_CONNECTION_STRING = 'mongodb+srv://Test:testbaru@cluster0.vrxlg8g.mongodb.net/?retryWrites=true&w=majority'


client = MongoClient('mongodb+srv://kentang:eUenw9z4QIlEoGzW@cluster0.mjce1r3.mongodb.net/?retryWrites=true&w=majority')
db = client.dbsweetest
...
def user(username):
    ...
    try:
        payload = jwt.decode(
            token_recieve, SECRET_KEY, algorithms=['HS256']
        )
